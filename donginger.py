...
class TelnetConnector:
    ...
    def connect(self):
        ...
        self.write(
            "connect %s %s" %
            (dong.config['username'],
             dong.config['password']))
        time.sleep(1)
...
class Processor:
    ...
    def __init__(self):
        ...
        self.chat_pat = re.compile(
            ...
            '|'.join(
                dong.config['monitored_nets'].keys()))
...
#				return ret
        ...
        # Direct talk or paging shortcut
            ...
            if verb[0] == '\'':
                ...
                self.process_line(
                    caller_name, line, caller_name, obj=caller_obj)
                return
